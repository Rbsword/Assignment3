...
namespace Assignment_3_Riva_Sword.Controllers
{
    public class ActorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Gender,age,IMBDLink,ActorPhoto,MovieId")] Actor actor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Gender,age,IMBDLink,ActorPhoto,MovieId")] Actor actor)
        {
            if (id != actor.Id)
            {
                return NotFound();
